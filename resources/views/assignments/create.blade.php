...
<div class="card card-primary card-outline">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="post" action="{{route('item.store')}}" >
                @csrf
                <div class="card-body">

                  <div class="form-group">
                    <label for="FirstName">Item Name</label>
                    <input type="text" required  name="name" class="form-control" id="exampleInputEmail1" placeholder="Enter Item">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" required  name="quantity" class="form-control" id="exampleInputEmail1" placeholder="Enter Qty">
                  </div>

                  <div class="form-group">
                    <label for="FirstName">Price</label>
                    <input type="number" required  name="price" class="form-control" id="exampleInputEmail1" placeholder="Enter Price">
                  </div>
