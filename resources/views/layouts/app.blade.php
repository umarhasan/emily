...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Emily</span>
    </a>
             ...
             @can('churche-list')
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  @can('churche-create')
                  <li class="nav-item">
                    <a href="{{route('churches.create')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Add churche</p>
                    </a>
                  </li>
...
@yield('content')
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022-2023 <a href="https://Emily">Emily</a>.</strong>
    All rights reserved.
